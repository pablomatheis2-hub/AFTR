...
export default function Layout({ children, onLogout }: LayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-[#0f0f1a] flex">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed lg:static inset-y-0 left-0 z-50 w-64 bg-[#1a1a2e] border-r border-[#2d2d44] transform transition-transform lg:transform-none ${
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        {/* Mobile header */}
        <header className="lg:hidden bg-[#1a1a2e] border-b border-[#2d2d44] p-4">
          <button
